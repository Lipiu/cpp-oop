...
#include "src/projectLogic.cpp"

int main() {
    std::string features = "Bluetooth, heated seats, parking sensors, 360 camera";
    Car myCar("BMW", "M5", "ZF8HP", 2022, features, 500, 600, 5, 50000, 300);
    Car myCar2("Toyota", "Supra", "Manual transmission", 2003, features, 300, 320, 3, 20000, 200);
    Car myCar3 = myCar2;
    Car myCar4 = myCar;
    Garage g;
